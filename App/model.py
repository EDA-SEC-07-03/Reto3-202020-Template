...
def newAnalyzer():
    ...
    analyzer['acidente'] = lt.newList('SINGLE_LINKED', compareIds)
...
def addCrime(analyzer, accidente):
    """
    """
    lt.addLast(analyzer['accidente'], accidente)
...
def updateDateIndex(map, accidente):
    ...
    """
    occurreddate = accidente['OCCURRED_ON_DATE']
